...
export function rightViewReducer(
    ...
    switch (action.type) {
        case RightViewStateType.ShowDefaultChat:
            log(`[RightView] set show default chat ${action.payload}`, 'info');
            return {
                ...state,
        ...
        case RightViewStateType.ShowContact:
            log(`[RightView] set show contact ${action.payload}`, 'info');
            return {
                ...state,
        ...
        case RightViewStateType.ShowHeader:
            log(`[RightView] set show header ${action.payload}`, 'info');
            return {
                ...state,
        ...
        case RightViewStateType.ShowProfile:
            log(`[RightView] set show profile ${action.payload}`, 'info');
            return {
                ...state,
        ...
        case RightViewStateType.ShowChat:
            log(`[RightView] set show chat ${action.payload}`, 'info');
            return {
                ...state,
