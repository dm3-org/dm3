...
&& yarn ts-json-schema-generator -f tsconfig.json --path notifications/channels/Email.ts --type EmailNotificationUserConfig -o ./src/schema/EmailNotificationUserConfig.schema.json --no-type-check \
